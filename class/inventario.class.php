<?php
    ...
    Class Inventario extends Database{
        ...
        function getPrecio_referencia(){return $this->precio_referencia;}
        ...
        function setPrecio_referencia($precio_referencia){return $this->precio_referencia=$precio_referencia;}
            ...
            if($stmt = $this->con->prepare($sql)){
                ...
                if($stmt = $this->con->prepare($sql_sel)){
                    ...
                    if($stmt = $this->con->prepare($sql_ins)){
                        ...
                        $precio_referencia = $this->getPrecio_referencia();
